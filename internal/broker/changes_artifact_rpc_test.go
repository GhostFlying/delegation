...
func TestPublishChangesArtifactWakesRootAndReplaysExactly(t *testing.T) {
	...
	wantArtifact := protocol.ChangesArtifactMetadata{
		...
		SourceDeviceID:          fixture.worker.DeviceID,
		WorkspaceSourceDeviceID: root.DeviceID,
		WorkspaceTargetDeviceID: fixture.worker.DeviceID,
		ObjectFormat:            fixture.manifest.ObjectFormat,
...
func prepareBrokerChangesFixture(
	...
	params := protocol.PublishChangesArtifactParams{
		...
		WorkspaceSourceDeviceID: root.DeviceID,
		WorkspaceTargetDeviceID: brokerTestSecondDeviceID,
