...
const (
	...
	MethodCreateWorkspaceTransfer = "workspace.transfer.create"
	MethodReadWorkspaceArtifact   = "workspace.transfer.read"
	MethodBeginWorkspaceTransfer  = "workspace.transfer.begin"
...
const (
	...
	MethodAuthorizeResultApply     = "artifact.result.apply.authorize"
)
